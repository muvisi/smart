...
#     def run_sync(self):
#         print("🔄 DB RENEWALS SYNC STARTED (CELERY TASK)")
...
#         try:
#             with connections[self.mssql_alias].cursor() as cursor:
#                 # ⚡ ONLY CHANGE: Fetch renewals instead of new schemes
            ...
            with connections[self.mssql_alias].cursor() as cursor:
                ...
                for row in rows:
                    ...
                    payload = {
                        ...
                        "startDate": str(scheme.get("start_date") or ""),
                        "endDate": str(scheme.get("end_date") or ""),
                        "polTypeId": str(scheme.get("scheme_type_id") or ""),
                        "userId": str(scheme.get("user_id") or "SYSTEM"),
                        "anniv": str(anniv),
                        "policyCurrencyId": getattr(settings, "POLICY_CURRENCY_ID", "KES"),
                        "countryCode": getattr(settings, "COUNTRY_CODE", "KE"),
