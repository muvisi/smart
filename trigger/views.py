            ...
            with connections["external_mssql"].cursor() as cursor:
                with transaction.atomic(using="external_mssql"):
                    ...
                    if section.lower() in ["members"]:
                        ...
                        placeholders = ",".join(["%s"] * len(family_members))

                        # 2️⃣ principal_applicant
                        cursor.execute(
                            """
